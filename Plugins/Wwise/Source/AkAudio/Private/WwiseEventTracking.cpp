...
namespace WwiseEventTriggering
{
	...
	void ResumePlayingID(UObject* Object, FAkAudioDevice * AudioDevice, FWwiseEventTracker & EventTracker, AkReal32 ProportionalTime, AkPlayingID InPlayingID)
	{
	...
	void SeekOnEvent(UObject* Object, FAkAudioDevice * AudioDevice, AkReal32 ProportionalTime, FWwiseEventTracker & EventTracker)
	{
		UE_LOG(LogAkAudio, VeryVerbose,
		       TEXT(
